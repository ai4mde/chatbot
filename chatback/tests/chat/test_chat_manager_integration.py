...
class MockRequirementsAgent:
    ...
    async def analyze_interview_file(self, chat_title):
        ...
        print(
            colored(
                f"Mock analyze_interview_file called with chat_title: {chat_title}",
                "blue",
            )
        )
...
async def test_chat_manager_integration():
    ...
    try:
        ...
        print(
            colored(
                f"Testing chat manager integration for session {session_id}...", "blue"
            )
        )
        ...
        response1 = await chat_manager.process_message(
            "Hello, I need a system for my business."
        )
        ...
        print(
            colored(
                "Chat manager state is still INTERVIEW after first message", "green"
            )
        )
        ...
        print(
            colored(
                "Processing second message to trigger interview completion...", "blue"
            )
        )
        response2 = await chat_manager.process_message(
            "I need user registration, login, and product search."
        )
        ...
        if mock_requirements_agent.analyze_called:
            print(
                colored(
                    "Requirements agent's analyze_interview_file was called", "green"
                )
            )
        else:
            print(
                colored(
                    "Requirements agent's analyze_interview_file was not called", "red"
                )
            )
        ...
        if "Agent Thompson is extracting and categorizing requirements" in response2:
            ...
            print(
                colored(
                    "Response does not contain requirements extraction message", "red"
                )
            )
        ...
        if "functional_requirements_path" in response2:
            ...
            print(
                colored("Response does not contain functional requirements path", "red")
            )
