...
async def test_full_process():
    ...
    try:
        ...
        print(colored(f"\n=== TESTING FULL INTERVIEW AND DOCUMENTATION PROCESS ===", "blue", attrs=["bold"]))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test the full interview and documentation process")
