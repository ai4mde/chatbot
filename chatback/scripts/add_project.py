...
async def create_project_system(
    username: str, password: str, project_name: str, system_name: str
):
...
def main():
    parser = argparse.ArgumentParser(
        description="Create a new project and system using ACC API"
    )
    parser.add_argument(
    ...
    asyncio.run(
        create_project_system(args.user, args.password, args.project, args.system)
    )
