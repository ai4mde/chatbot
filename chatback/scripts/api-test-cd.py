...
async def test_class_diagram(username: str, password: str):
    ...
    try:
        ...
        try:
            ...
            relationship_lines = [
                line.strip() for line in CLASS_DIAGRAM.split("\n") if "--" in line
            ]
            ...
            for line in relationship_lines:
                try:
                    ...
                    if (
                        source_class not in class_nodes
                        or target_class not in class_nodes
                    ):
                        print(
                            f"⚠️ Warning: Could not find classes for relationship: {line}"
                        )
                        continue
                    ...
                    print(
                        f"✅ Created relationship between '{source_class}' and '{target_class}'"
                    )
...
def main():
    parser = argparse.ArgumentParser(
        description="Test class diagram creation with ACC API"
    )
