...
class UMLConverterAgent:
    ...
    async def create_diagram(
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                response = await client.post(
                    f"{self.studio_api_url}/diagram/",  # Added trailing slash
                    headers={
                        "accept": "application/json",
                        "Content-Type": "application/json",
                        "Authorization": f"Bearer {self.access_token}",
    ...
    async def verify_project(self, project_id: str) -> Dict:
        ...
        try:
            ...
            logger.error(f"Failed to verify project: {str(e)}")
            raise
    ...
    async def add_edge(
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                response = await client.post(
                    f"{self.studio_api_url}/diagram/{diagram_id}/edge/",
                    headers={
                        "accept": "application/json",
                        "Content-Type": "application/json",
                        "Authorization": f"Bearer {self.access_token}",
    ...
    async def add_actor(
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                response = await client.post(
                    f"{self.studio_api_url}/diagram/{diagram_id}/node/",
                    headers={
                        "accept": "application/json",
                        "Content-Type": "application/json",
                        "Authorization": f"Bearer {self.access_token}",
                ...
                # Return response with data structure matching the script's expectations
                return {"data": {"id": response_data["id"]}}
        except Exception as e:
        ...
        try:
            ...
            if properties:
                ...
                if "operation" in properties:
                    request_data["cls"]["operation"] = properties["operation"]
