...
from app.models.chat import ChatSession, ChatMessage, ChatRole, ChatState, ConversationState
...
async def get_chat_messages(
    ...
    try:
        ...
        # Log the user info being saved
        logger.info(f"Updating user info in Redis for session {session_id}: {user_info}")
