...
# Setup logging using the custom configuration
# The log level can be controlled via an environment variable or setting later if needed
setup_logging(log_level=settings.LOG_LEVEL)

# Remove the basicConfig as setup_logging handles it now
# logging.basicConfig(
#     level=logging.INFO,
